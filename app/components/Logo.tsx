...
export function Logo() {
    ...
    return (
        <Link
            ...
            className={`flex items-center gap-2 select-none group transition-opacity duration-300 ${isActive ? "opacity-100" : "opacity-70 hover:opacity-100"
                }`}
        >
            <div className="relative w-8 h-8 flex items-center justify-center">
                ...
                {/* Glow Effect */}
                <div
                    className={`absolute inset-0 blur-md transition-opacity duration-500 ${isActive ? "opacity-60" : "opacity-0 group-hover:opacity-50"
                        }`}
                ...
                >
                    <defs>
                        ...
                        <linearGradient id={gradientId} gradientUnits="userSpaceOnUse" x1="0%" y1="0%" x2="100%" y2="100%">
                            ...
                            <stop offset="100%" stopColor="var(--primary-lightest-color, #ffffff)" />
                        </linearGradient>

                        {/* estrella giratoria */}
                        <mask id={maskId}>
                            <path
                                className="transition-transform duration-700 ease-in-out group-hover:rotate-180 origin-center"
                                fill="white"
